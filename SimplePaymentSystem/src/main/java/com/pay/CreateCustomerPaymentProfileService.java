...
@Service
public class CreateCustomerPaymentProfileService {

	public CreateCustomerPaymentProfileResponse createCardProfile(String apiLoginId, String transactionKey, String customerProfileId) {
